...
const facilityData = {
    ...
    medicalFacilityUnits: [
          ...
          { name: "قسم أشعة وتشخيص", icon: "fa-x-ray" },
            { name: "صيدلية داخلية", icon: "fa-pills" },
            { name: "نظام غازات طبية", icon: "fa-lungs" },
          { name: "غرفة تعقيم مركزي", icon: "fa-hand-sparkles" },
            { name: "غرف عناية مركزة", icon: "fa-heartbeat" },
          { name: "وحدة طوارئ واستقبال", icon: "fa-ambulance" }
    ],

    schools: [
        { name: "فصول دراسية", icon: "fa-chalkboard-teacher" },
        { name: "معامل علمية", icon: "fa-flask" },
        { name: "مكتبة", icon: "fa-book" },
        { name: "ملاعب", icon: "fa-futbol" },
        { name: "مسارح وأنشطة", icon: "fa-theater-masks" },
        { name: "غرف حاسب آلي", icon: "fa-desktop" }
    ],

    hotels: [
        { name: "غرف فندقية", icon: "fa-bed" },
        { name: "مطابخ مركزية", icon: "fa-utensils" },
        { name: "مطاعم وكافيهات", icon: "fa-coffee" },
        { name: "حمامات سباحة", icon: "fa-swimmer" },
        { name: "مغسلة مركزية", icon: "fa-soap" },
        { name: "قاعات مناسبات", icon: "fa-glass-cheers" }
    ],

    resorts: [
        { name: "شاليهات ووحدات إقامة", icon: "fa-house-user" },
        { name: "أنشطة ترفيهية", icon: "fa-water" },
        { name: "مناطق ألعاب", icon: "fa-child" },
        { name: "مطاعم شاطئية", icon: "fa-umbrella-beach" },
        { name: "مراسي بحرية", icon: "fa-anchor" }
    ],
      mobileFoodUnits: [
    { name: "وحدة تجهيز طعام متنقلة", icon: "fa-truck" },
    { name: "معدات طهي متنقلة", icon: "fa-burn" },
    { name: "وحدة تبريد وتجميد", icon: "fa-snowflake" },
    { name: "خزانات مياه نظيفة", icon: "fa-water" },
    { name: "نظام صرف صحي متنقل", icon: "fa-toilet" },
    { name: "منطقة خدمة وتقديم", icon: "fa-hamburger" }
     ],
    ...
    { name: "منطقة استلام الخامات", icon: "fa-box" }
     ],
         
      constructionUnits: [
    { name: "معدات ثقيلة وآلات", icon: "fa-truck-pickup" },
    { name: "مكتب فني وهندسي", icon: "fa-drafting-dot-plot" },
    { name: "مخازن تشوين الخامات", icon: "fa-warehouse" },
    { name: "أدوات ومعدات سلامة", icon: "fa-hard-hat" },
    { name: "وحدة مساحة وقياس", icon: "fa-compass" },
    { name: "طاقم إشراف وتوجيه", icon: "fa-users-cog" }
      ],
     
       waterUtilityUnits: [
    { name: "وصلة مياه شرب", icon: "fa-tint" },
    { name: "وصلة صرف صحي", icon: "fa-fill-drip" },
    { name: "غرفة عدادات مجهزة", icon: "fa-tachometer-alt" },
    ...
    { name: "وحدة فحص وتأكيد الجودة", icon: "fa-check-double" },
    ...
    { name: "أنظمة التتبع الآلي", icon: "fa-location-dot" },
    { name: "كابلات ألياف ضوئية", icon: "fa-route" },
    { name: "مركز خدمة العملاء", icon: "fa-headset" }
       ],
       
               petroleumUnits: [
    { name: "منصة حفر واستكشاف", icon: "fa-oil-well" },
    { name: "منفذ تسويق (محطة وقود)", icon: "fa-gas-pump" },
    { name: "وحدة معالجة الخام", icon: "fa-industry" },
    { name: "مختبر تحاليل جيولوجية", icon: "fa-microscope" },
    { name: "مستودعات تخزين وقود", icon: "fa-fill-drip" },
    { name: "وحدة خدمات مساندة", icon: "fa-tools" }
        ],
               gasRegUnits: [
    { name: "محطة استقبال وتخفيف ضغط", icon: "fa-bore-hole" },
    { name: "وحدة إعادة تغاز (Regasification)", icon: "fa-fire-burner" },
    { name: "خطوط أنابيب النقل", icon: "fa-grip-lines" },
    { name: "منظومة قياس ذكية (Metering)", icon: "fa-gauge-high" },
    { name: "خزانات غاز مسال (LNG)", icon: "fa-database" },
    ...
    { name: "معمل تحاليل جيولوجية", icon: "fa-vial-virus" },
    { name: "مخزن خام رئيسي", icon: "fa-warehouse" },
    { name: "مستودع مهمات ومعدات ثقيلة", icon: "fa-truck-pickup" },
    { name: "مكتب الإدارة والمساحة", icon: "fa-compass" }
       ],
                  electricityUnits: [
    { name: "محطة توليد (شمسية/رياح/غازية)", icon: "fa-solar-panel" },
    { name: "غرفة المحولات (Substation)", icon: "fa-bolt-lightning" },
    { name: "مركز التحكم والسكادا", icon: "fa-desktop" },
    ...
    { name: "خطوط نقل هوائية (أبراج)", icon: "fa-tower-observation" },
    { name: "كابلات جهد عالي أرضية", icon: "fa-grip-lines" },
    { name: "أنظمة التحكم والسكادا", icon: "fa-microchip" },
    { name: "وحدات القياس والعدادات", icon: "fa-gauge-high" },
    { name: "خلايا التوزيع (الجهد المتوسط)", icon: "fa-table-cells" }
            ],

            solarNreaUnits: [
    { name: "ألوح خلايا شمسية", icon: "fa-solar-panel" },
    { name: "محولات تيار (Inverters)", icon: "fa-bolt" },
    { name: "نظام تثبيت معدني", icon: "fa-grid-2" },
    { name: "أجهزة حماية وتحكم", icon: "fa-shield-halved" },
    { name: "كابلات ومنظومة تاريض", icon: "fa-link" },
    ...
    { name: "الوحدة الطبية والإسعاف", icon: "fa-rated-people" },
    { name: "المراكز البحثية والوحدات الخاصة", icon: "fa-microscope" }
       ],
        schoolUnits: [
    ...
    { name: "الوحدة الصحية المدرسية", icon: "fa-briefcase-medical" }
           ...
           millingUnits: [
    { name: "نقرة استقبال مجهزة بشبكة وشفاط", icon: "fa-truck-field" },
    { name: "صوامع القمح الخام (سعة ٥ أيام)", icon: "fa-tower-observation" },
    { name: "صوامع الإعداد (الترطيب والراحة)", icon: "fa-droplet" },
    { name: "قسم الطحن (سلندرات / ديسك ميل)", icon: "fa-gears" },
    { name: "سيلوات الدقيق والنخالة والتعبئة", icon: "fa-boxes-packing" }
        ],
    ...
    { name: "أنفاق وآلات التجفيف الحراري", icon: "fa-hot-tub-person" },
    { name: "مناشر التجفيف الشمسي المحمية", icon: "fa-sun" },
    { name: "أجهزة قياس الرطوبة والحرارة", icon: "fa-temperature-half" },
    { name: "وحدة التعبئة المفرغة من الهواء", icon: "fa-box-tissue" }
      ],
                  frozenFoodUnits: [
    { name: "أنفاق التجميد السريع (Blast Freezers)", icon: "fa-icicles" },
    { name: "خطوط التقطيع والتجهيز الآلي", icon: "fa-shredder" },
    { name: "ماكينات التغليف الحراري والشفط", icon: "fa-box-open" },
    { name: "ثلاجات التخزين المركزي المبردة", icon: "fa-snowflake" },
    { name: "أسطول النقل المبرد المجهز", icon: "fa-truck-frozen" }
       ],
                   refrigerationUnits: [
    { name: "وحدات التبريد والتجميد المركزية", icon: "fa-snowflake" },
    { name: "غرف التخزين (ساندوتش بانل)", icon: "fa-warehouse" },
    { name: "أنظمة مراقبة درجات الحرارة آلياً", icon: "fa-temperature-low" },
    ...
    { name: "وحدات تلميع وتبريد الأرز", icon: "fa-fan" },
    ...
    { name: "صهاريج تخزين الزيوت الخام والمكررة", icon: "fa-database" },
    { name: "خطوط التعبئة والوزن الآلي", icon: "fa-bottle-water" },
    ...
    { name: "موازين المعايرة الرقمية المعتمدة", icon: "fa-scale-unbalanced" },
    { name: "أنظمة الإنذار والإطفاء التلقائي", icon: "fa-bell-exclamation" },
    ...
    { name: "أجهزة كشف تسريب الغاز المحمولة", icon: "fa-sensor" },
    { name: "موازين ميكانيكية لمعايرة الأسطوانات", icon: "fa-scale-balanced" },
    { name: "ساحة تخزين الأسطوانات الفارغة والمملوءة", icon: "fa-warehouse" }
           ],
    ...
    { name: "منظومة المراقبة والقياس الآلي (ATG)", icon: "fa-gauge-high" },
    { name: "منطقة خدمات السيارات (غسيل/زيوت)", icon: "fa-car-wash" }
         ],
    ...
    { name: "مخازن مجهزة بنظام الأرفف الذكية", icon: "fa-warehouse" },
    { name: "منظومة المراقبة والتحكم المركزية", icon: "fa-video" }
         ],
                             grindingUnits: [
    { name: "وحدات الدش والجرش (المطارق)", icon: "fa-hammer" },
    { name: "سيور نقل الحبوب وآلات الرفع", icon: "fa-up-down-left-right" },
    { name: "منظومة سحب الغبار والفلترة", icon: "fa-wind" },
    { name: "موازين التعبئة والتحميل", icon: "fa-scale-balanced" },
    { name: "وحدات تخزين الحبوب (الصوامع الصغيرة)", icon: "fa-boxes-stacked" }
          ],

                 bananaRipeningUnits: [
    { name: "غرف الإنضاج المعزولة حرارياً", icon: "fa-door-closed" },
    { name: "منظومة حقن غاز الإيثيلين", icon: "fa-wind" },
    { name: "أجهزة ضبط الرطوبة والحرارة", icon: "fa-temperature-quarter" },
    { name: "وحدات التبريد والمراوح", icon: "fa-fan" },
    { name: "منطقة فرز وتعبئة الكراتين", icon: "fa-box" }
            ],

                   medicalWasteTransportUnits: [
    { name: "سيارات نقل مجهزة ومغلقة (نقل مخلفات)", icon: "fa-truck-moving" },
    { name: "أنظمة تتبع السيارات (GPS)", icon: "fa-location-dot" },
    { name: "أدوات تطهير وتعقيم السيارات", icon: "fa-pump-medical" },
    { name: "مهمات الوقاية الشخصية للعاملين", icon: "fa-mask-ventilator" },
    { name: "جراج مبيت مؤمن وموافق عليه فنياً", icon: "fa-warehouse" }
           ],
    ...
    { name: "مخازن مؤقتة مؤمنة ومطابقة للمواصفات", icon: "fa-warehouse" }
            ],
    ...
    { name: "محطة المياه الصيدلية (Water Station)", icon: "fa-faucet-drip" }
          ],

             combinedUnits: [
    { name: "سيارات نقل مجهزة ومغلقة", icon: "fa-truck-moving" },
    { name: "أنظمة تتبع السيارات (GPS)", icon: "fa-location-dot" },
    { name: "أدوات تطهير وتعقيم السيارات", icon: "fa-pump-medical" },
    { name: "مهمات الوقاية الشخصية للعاملين", icon: "fa-mask-ventilator" },
    { name: "جراج مبيت حاصل على موافقة الحماية المدنية", icon: "fa-warehouse" },
    { name: "وحدات الفرز والفصل والتدوير الميكانيكي", icon: "fa-recycle" },
    { name: "معدات المعالجة الكيميائية والفيزيائية", icon: "fa-vial-circle-check" },
    { name: "أنظمة التعقيم وتطهير السيارات والموقع", icon: "fa-spray-can-sparkles" }
       ],

            tollDrugUnits: [
    { name: "مقر إداري منفصل ومعاين فنياً", icon: "fa-building-circle-check" },
    { name: "وحدة حفظ سجلات التتبع الدوائي", icon: "fa-database" },
    { name: "منظومة السجل الإلكتروني للشركة (Profile)", icon: "fa-id-card-clip" },
    { name: "أرشيف ملفات تسجيل المستحضرات الطبية", icon: "fa-file-prescription" }
          ],
    ...
    { name: "منظومة الربط الإلكتروني للاستيراد", icon: "fa-network-wired" },
    ...
    { name: "أرفف وطبليات تخزين مطابقة للمواصفات", icon: "fa-boxes-stacked" },
    { name: "وحدة تبريد (ثلاجة) للمستحضرات الحساسة", icon: "fa-snowflake" }
             ],

                 fullMedUnits: [
    { name: "مقر إداري مدمج (تصنيع واستيراد)", icon: "fa-building-shield" },
    { name: "مخزن طبي مرخص (100م2 فأكثر)", icon: "fa-warehouse" },
    { name: "منظومة السجلات الإلكترونية الموحدة (Profile)", icon: "fa-computer" },
    { name: "أرشيف ملفات الاستيراد والتصنيع المحلي", icon: "fa-file-medical" }
         ],
                       storeTechUnits: [
    { name: "منطقة استلام وفحص الأصناف", icon: "fa-dolly" },
    { name: "وحدة التبريد المركزي (Cold Room)", icon: "fa-snowflake" },
    { name: "منظومة تسجيل الحرارة الرقمية", icon: "fa-chart-line" },
    { name: "منطقة الحجر الصحي للأدوية (Quarantine)", icon: "fa-lock" }
               ],

                   wellTechUnits: [
    { name: "غرفة طلمبة الرفع والتحكم", icon: "fa-faucet-drip" },
    { name: "عداد قياس التصرف (Flow Meter)", icon: "fa-gauge-high" },
    { name: "وحدة معالجة أولية (حسب الملوحة)", icon: "fa-filter" },
    { name: "خزان مياه أرضي للترسيب", icon: "fa-water" }
           ],

        hotelUnits: [
    { name: "قطاع الغرف والخدمات (Housekeeping)", icon: "fa-bed" },
    { name: "إدارة الأغذية والمشروبات (F&B)", icon: "fa-utensils" },
    { name: "منظومة الأمن والتحكم (Security/CCTV)", icon: "fa-user-shield" },
    { name: "المرافق العامة (حمامات سباحة/نادي صحي)", icon: "fa-water-ladder" }
       ],
        
        restUnits: [
    { name: "منطقة الاستقبال والضيافة", icon: "fa-chair" },
    { name: "المطبخ المركزي (Main Kitchen)", icon: "fa-fire-burner" },
    { name: "منظومة التبريد والتخزين", icon: "fa-refrigerator" },
    { name: "منطقة العرض الفني (إن وجدت)", icon: "fa-microphone" }
      ],
              bazaarUnits: [
    { name: "ركن المستنسخات الأثرية والمعروضات", icon: "fa-monument" },
    { name: "وحدة التغليف المؤمن (Fragile Packing)", icon: "fa-box" },
    { name: "أنظمة الدفع الدولي والتحويل العملي", icon: "fa-credit-card" },
    { name: "ركن المنسوجات والزي التقليدي", icon: "fa-shirt" }
         ],

              campUnits: [
    { name: "وحدات الإقامة البيئية (Eco-Tents)", icon: "fa-tent" },
    { name: "منطقة الخدمات والمطبخ المفتوح", icon: "fa-fire-burner" },
    { name: "نظام الصرف الصحي والتحلل الذاتي", icon: "fa-biohazard" },
    { name: "محطة الطاقة الشمسية المتنقلة", icon: "fa-sun" }
        ],

           cruiseUnits: [
    { name: "غرفة المحركات والمولدات (Engine Room)", icon: "fa-gears" },
    { name: "كابينة القيادة وأجهزة الملاحة (Bridge)", icon: "fa-ship" },
    { name: "محطة معالجة الصرف (STP Plant)", icon: "fa-biohazard" },
    { name: "منطقة السطح والمطعم (Sundeck & Restaurant)", icon: "fa-umbrella-beach" }
         ],

               productionUnits: [
    { name: "وحدة السيناريو والملكية الفكرية", icon: "fa-file-pen" },
    ...
    { name: "إدارة قيد التصرفات والسجلات", icon: "fa-book-bookmark" }
                   ...
                   exhibitionUnits: [
    { name: "قاعة العرض أو الصالة الرئيسية", icon: "fa-masks-theater" },
    { name: "غرفة العرض (Projection Room)", icon: "fa-film" },
    { name: "منطقة الألعاب الرقمية والتحكم", icon: "fa-gamepad" },
    { name: "أنظمة الصوت والإضاءة المسرحية", icon: "fa-lightbulb" }
           ],
                  distributionUnits: [
    { name: "مخزن المصنفات المؤمن (Climate Controlled)", icon: "fa-warehouse" },
    { name: "منطقة العرض والبيع للجمهور", icon: "fa-shop" },
    { name: "وحدة فحص وتأكيد النسخ الأصلية", icon: "fa-shield-check" },
    { name: "إدارة العقود وسجلات التوزيع", icon: "fa-file-signature" }
       ],

             shootingUnits: [
    { name: "وحدة الكاميرات والعدسات (Camera Dept)", icon: "fa-camera-movie" },
    { name: "وحدة الإضاءة والكهرباء (Grip & Lighting)", icon: "fa-lightbulb-on" },
    { name: "موقع التصوير أو البلاتوه (Set)", icon: "fa-clapperboard" },
    { name: "إدارة الإنتاج وتراخيص المواقع", icon: "fa-location-dot" }
],
duplicationUnits: [
    { name: "وحدة النسخ الرئيسية (Mastering Unit)", icon: "fa-compact-disc" },
    { name: "وحدة الطباعة والتغليف الفني", icon: "fa-print" },
    { name: "وحدة مراقبة الجودة والرقابة الأمنية", icon: "fa-check-double" },
    { name: "مخزن النسخ الجاهزة للتداول", icon: "fa-boxes-stacked" }
],
conversionUnits: [
    { name: "وحدة معالجة الوسائط القديمة (Legacy Media)", icon: "fa-tape" },
    { name: "منظومة التحويل الرقمي (Digital Conversion)", icon: "fa-shuffle" },
    { name: "وحدة مراقبة الجودة والترميم الرقمي", icon: "fa-wand-magic-sparkles" },
    { name: "وحدة الأرشفة وسجل قيد التحويلات", icon: "fa-database" }
],
recordingUnits: [
    { name: "غرفة التسجيل المعزولة (Recording Room)", icon: "fa-microphone" },
    { name: "غرفة التحكم والهندسة الصوتية (Control Room)", icon: "fa-sliders" },
    { name: "وحدة الأرشفة الرقمية والسجلات", icon: "fa-hard-drive" },
    { name: "منطقة انتظار المؤدين والفنانين", icon: "fa-users" }
],
cinemaLogisticsUnits: [
    { name: "وحدة التخليص الجمركي السينمائي", icon: "fa-ship" },
    { name: "مخزن مؤمن للمواد الدعائية والأفلام", icon: "fa-vault" },
    { name: "إدارة علاقات شركات الإنتاج الأجنبية", icon: "fa-earth-americas" },
    { name: "وحدة تتبع الشحنات وبوالص التأمين", icon: "fa-file-invoice" }
],

fishFarmUnits: [
    { name: "مصفوفة الأقفاص العائمة (Floating Cages)", icon: "fa-circle-dot" },
    { name: "وحدة التغذية والتحكم الآلي", icon: "fa-shrimp" },
    { name: "رصيف الخدمة واللوجستيات البحرية", icon: "fa-anchor" },
    { name: "وحدة المراقبة الجوية والبحرية للموقع", icon: "fa-tower-observation" }
],
integratedFarmUnits: [
    { name: "أحواض الاستزراع المكثف (Fish Tanks)", icon: "fa-dharmachakra" },
    { name: "منظومة الفلترة البيولوجية والتدوير", icon: "fa-filter" },
    { name: "الصوبات الزراعية التكاملية (Greenhouses)", icon: "fa-seedling" },
    { name: "وحدة التسميد العضوي السائل (Fertigation Unit)", icon: "fa-droplet" }
],

privateLandFarmUnits: [
    { name: "أحواض التحضين والتربية الترابية/الأسمنتية", icon: "fa-border-all" },
    { name: "محطة رفع ومعالجة مياه الري والصرف", icon: "fa-faucet-drip" },
    { name: "وحدة البدالات وأجهزة التهوية الميكانيكية", icon: "fa-fan" },
    { name: "مخازن الأعلاف ووحدات التبريد للمنتج", icon: "fa-temperature-arrow-down" }
],
poultryProductionUnits: [
    { name: "عنابر التربية والإنتاج (تسمين/بياض)", icon: "fa-house-chimney-window" },
    { name: "وحدة التفريخ والفقاسات الآلية", icon: "fa-egg" },
    { name: "منظومة التحكم البيئي (تهوية وتبريد)", icon: "fa-wind" },
    { name: "مخازن الأعلاف ووحدات الأمان الحيوي", icon: "fa-shield-virus" }
],
feedProductionUnits: [
    { name: "وحدة الموازين وتجهيز الخامات الأولية", icon: "fa-scale-balanced" },
    { name: "خط الإنتاج والخلط الآلي (Pelleting/Mixing)", icon: "fa-gears" },
    { name: "معمل التحليل الكيميائي ورقابة الجودة", icon: "fa-flask-vial" },
    { name: "مستودعات تخزين المنتج النهائي المبردة", icon: "fa-warehouse" }
],
geneticsProductionUnits: [
    { name: "بنك الأصول الوراثية وحفظ السائل المنوي", icon: "fa-dna" },
    { name: "معمل التلقيح الاصطناعي ونقل الأجنة", icon: "fa-microscope" },
    { name: "وحدة رعاية الطلائق والحيوانات المانحة", icon: "fa-cow" },
    { name: "منظومة النيتروجين السائل والتبريد العميق", icon: "fa-snowflake" }
],
feedRegistrationUnits: [
    { name: "وحدة رقابة الجودة وتطوير التركيبات", icon: "fa-vial-circle-check" },
    { name: "مخزن الحجر الصحي للمنتجات المستوردة", icon: "fa-box-security" },
    { name: "إدارة الشؤون الفنية والتسجيلات", icon: "fa-file-shield" },
    { name: "وحدة سحب العينات والتوثيق المخبري", icon: "fa-clipboard-check" }
],
desertFarmUnits: [
    { name: "محطات التربية المفتوحة والمظللة", icon: "fa-cow" },
    { name: "وحدة حفر الآبار ومنظومة الري والتحلية", icon: "fa-bore-hole" },
    { name: "مركز تجميع الألبان ووحدات التبريد العميق", icon: "fa-truck-droplet" },
    { name: "وحدة إنتاج السيلاج وتخزين الأعلاف الجافة", icon: "fa-tractor" }
],
poultryTradeUnits: [
    { name: "وحدة التخليص والحجر البيطري", icon: "fa-plane-import" },
    { name: "مستودعات المعدات والتجهيزات الفنية", icon: "fa-warehouse" },
    { name: "وحدة متابعة السلالات والتحسين الوراثي", icon: "fa-dna" },
    { name: "أسطول نقل الدواجن المجهز (تحكم حراري)", icon: "fa-truck-fast" }
],
livestockImportUnits: [
    { name: "إدارة الاستيراد والتوثيق الوراثي", icon: "fa-file-signature" },
    { name: "وحدة حاويات النيتروجين السائل (Cryogenic)", icon: "fa-vial" },
    { name: "أسطول نقل الماشية المجهز دولياً", icon: "fa-truck-moving" },
    { name: "وحدة المتابعة البيطرية بمحجر الشركة", icon: "fa-stethoscope" }
],
dairyCollectionUnits: [
    { name: "وحدة الاستلام ومنصة فحص الألبان", icon: "fa-truck-field" },
    { name: "مختبر رقابة الجودة والتحليل الكيميائي", icon: "fa-microscope" },
    { name: "تنكات التبريد السريع (Bulk Milk Coolers)", icon: "fa-snowflake" },
    { name: "وحدة الغسيل والتعقيم المركزي (CIP Unit)", icon: "fa-soap" }
],

apiaryProductionUnits: [
    { name: "وحدات الخلايا الخشبية (الخلايا الحديثة)", icon: "fa-boxes-stacked" },
    { name: "وحدة تربية الملكات والتلقيح", icon: "fa-crown" },
    { name: "معمل فرز وتصفية العسل", icon: "fa-faucet-drip" },
    { name: "مخزن أدوات النحالة ومنظومة التعبئة", icon: "fa-jar" }
],
pharmacyProductionUnits: [
    { "name": "منطقة الاستقبال والاستشارة البيطرية الأولية", "icon": "fa-user-md" },
    { "name": "أرفف وعرض منتجات الأدوية البيطرية", "icon": "fa-shelves" },
    { "name": "مخزن الأدوية الرئيسي (مبرد/عادي)", "icon": "fa-temperature-low" },
    { "name": "منطقة حفظ السجلات والمستندات القانونية", "icon": "fa-folder-open" }
],

biologicalsProductionUnits: [
    { "name": "منطقة الاستقبال والاستشارة الفنية", "icon": "fa-syringe" },
    { "name": "ثلاجات حفظ المستحضرات البيولوجية (سلسلة تبريد)", "icon": "fa-snowflake" },
    { "name": "مخزن المستلزمات والمواد التكميلية", "icon": "fa-box" },
    { "name": "منطقة حفظ سجلات الدُفعات وتواريخ الصلاحية", "icon": "fa-clipboard-check" }
],

pesticideStorageUnits: [
    { "name": "منطقة التخزين الرئيسية للمبيدات (مفصولة عن مواد أخرى)", "icon": "fa-boxes-stacked" },
    { "name": "منطقة العزل للمواد الخطرة والسامة", "icon": "fa-radiation" },
    { "name": "نظام تهوية واستخراج للهواء الملوث", "icon": "fa-fan" },
    { "name": "غرفة معدات السلامة والوقاية الشخصية", "icon": "fa-hard-hat" },
    { "name": "منطقة استلام وتسجيل الشحنات (مع فحص أولي)", "icon": "fa-clipboard-check" }
],


clinicPharmacyUnits: [
    { "name": "منطقة الاستقبال والكشف الإكلينيكي", "icon": "fa-stethoscope" },
    { "name": "صيدلية العيادة (تخزين وصرف الأدوية)", "icon": "fa-prescription-bottle-medical" },
    { "name": "غرفة الإسعافات الأولية والإجراءات البسيطة", "icon": "fa-briefcase-medical" },
    { "name": "مكتب الطبيب وسجلات المرضى", "icon": "fa-notes-medical" }
],

clinicBiologicalsUnits: [
    { "name": "منطقة الاستقبال والكشف الإكلينيكي", "icon": "fa-stethoscope" },
    { "name": "وحدة التبريد لحفظ المستحضرات البيولوجية (ثلاجات متخصصة)", "icon": "fa-temperature-low" },
    { "name": "غرفة التحضير والإعطاء (حقن، تحصين)", "icon": "fa-syringe" },
    { "name": "مكتب الطبيب وسجلات التحصين والعلاج", "icon": "fa-clipboard-list" }
],

pharmacyBiologicalsUnits: [
    { "name": "منطقة الاستقبال والاستشارة الفنية المتخصصة", "icon": "fa-user-md" },
    { "name": "أرفف عرض وتخزين الأدوية البيطرية (منطقة جافة)", "icon": "fa-shelves" },
    { "name": "وحدات التبريد المتخصصة للمستحضرات البيولوجية (سلسلة تبريد)", "icon": "fa-temperature-low" },
    { "name": "منطقة الفصل والتجهيز للطلبات والوصفات", "icon": "fa-box-open" },
    { "name": "نظام أرشفة السجلات والمستندات القانونية للدفعات", "icon": "fa-archive" }
],

clinicCombinedUnits: [
    { "name": "منطقة الاستقبال والكشف الإكلينيكي", "icon": "fa-stethoscope" },
    { "name": "صيدلية العيادة (تخزين وصرف الأدوية)", "icon": "fa-prescription-bottle-medical" },
    { "name": "وحدة التبريد لحفظ المستحضرات البيولوجية", "icon": "fa-snowflake" },
   ...
   bakeryUnits: [
    { name: "أفران الإنتاج (نصف آلي / آلي / دوار)", icon: "fa-fire-burner" },
    { name: "عجانات آلية ستانلس ستيل", icon: "fa-blender" },
    { name: "طاولات التقطيع الخشبية أو الرخامية", icon: "fa-table" },
    { name: "موازين إلكترونية معتمدة للمعايرة", icon: "fa-scale-balanced" },
      { name: "بيت النار (الأفران)", icon: "fa-fire-burner" },
      { name: "ماكينة صرف الخبز (Smart)", icon: "fa-credit-card" },
    { name: "وحدة تخزين الدقيق (المخزن المسقوف)", icon: "fa-box-archive" }
         ]
};
...
//--------------------------------
// دالة للتحكم في ظهور التجهيزات المتخصصة بناءً على النشاط
// دالة مطورة وذكية للتحكم في ظهور التجهيزات المتخصصة بناءً على قاعدة البيانات
function updateSpecializedFacilityVisibility(activityValue) {
    // 1. إخفاء كافة صناديق التجهيزات التي تنتهي بكلمة "-box" لتصفية الشاشة
    document.querySelectorAll('[id$="-box"]').forEach(box => {
        box.style.display = 'none';
    });

    // 2. البحث عن بيانات النشاط المختار من قاعدة البيانات المركزية
    const activityData = masterActivityDB.find(act => act.value === activityValue);

    // 3. إذا وجدنا النشاط ووجدنا لديه مصفوفة تجهيزات خاصة
    if (activityData && activityData.specializedFacilities && activityData.specializedFacilities.length > 0) {
        
        console.log(`🔍 جاري إظهار التجهيزات الخاصة بنشاط: ${activityData.text}`);
        
        // 4. المرور على كل ID موجود في المصفوفة وإظهاره
        activityData.specializedFacilities.forEach(boxId => {
            const targetBox = document.getElementById(boxId);
            if (targetBox) {
                targetBox.style.display = 'block';
                console.log(`✅ تم إظهار الصندوق: ${boxId}`);
            } else {
                console.warn(`⚠️ تحذير: الصندوق ذو المعرف ${boxId} غير موجود في ملف HTML`);
            }
        });
    } else {
        console.log("ℹ️ هذا النشاط لا يتطلب صناديق تجهيزات متخصصة إضافية.");
    }
}
...
// تحديث واجهة النجاح (تتم بنجاح لأنه تم تعريف statusDiv و errorDiv)
statusDiv.style.display = 'block';
errorDiv.style.display = 'none';
button.disabled = false;
button.innerHTML = `✅ تم التحديد (الدقة: ${Math.round(accuracy)}م)`;
    ...
    auditFinancials: function(data) {
        ...
        if (totalPurchases > 0 && totalSales > 0) {
            ...
            results.push({
                type: 'primary',
                priority: 6,
                msg: `📦 <b>رأس مال معطل:</b> سيولة مجمعة في المخزون بقيمة <b>${totalPurchases.toLocaleString()}</b> ${this.config.currencySymbol} بانتظار التصنيع/البيع.`
            });
        }
...
/* ==========================================================================
   🚑 الإصلاح الشامل والنهائي: تعريف دوال الواجهة (Global UI Functions)
   يجب وضع هذا الكود في نهاية ملف js/app.js
   ========================================================================== */

// -----------------------------------------------------------------------
// 1️⃣ إصلاح أخطاء القرار 104 (ReferenceErrors + القوائم)
// -----------------------------------------------------------------------

// إصلاح خطأ البحث (حتى لو لم نستخدمه، يجب أن يكون موجوداً لمنع الخطأ)
/* ==========================================================================
   🔍 البحث العميق في القرار 104 (Deep Search Algorithm)
   يعالج البيانات المتداخلة (قطاع رئيسي > فرعي > نشاط)
   ========================================================================== */

window.searchActivity = function() {
    const inputField = document.getElementById('activitySearch');
    const resultsContainer = document.getElementById('searchResults');
    
    if (!inputField || !resultsContainer) return;

    const query = inputField.value.trim().toLowerCase(); // تحويل لحروف صغيرة للمقارنة

    // 1. إخفاء النتائج إذا كان النص قصيراً
    if (query.length < 2) {
    ...
    if (typeof decision104DB === 'undefined') {
        console.error("قاعدة بيانات القرار 104 غير موجودة");
        return;
    }

    let matches = [];

    // --- دالة الحفر العميق (Recursive Search) ---
    // هذه الدالة تبحث في كل الزوايا والخبايا داخل البيانات
    function deepDive(data, sectorName, badgeColor) {
        if (!data) return;

        // إذا وصلنا لمصفوفة (قائمة الأنشطة النهائية)
        if (Array.isArray(data)) {
            data.forEach(activity => {
                if (activity.toLowerCase().includes(query)) {
                    matches.push({
                        activity: activity,
                        path: sectorName, // المسار (مثل: قطاع أ - صناعة)
                        sector: sectorName.includes('(أ)') ? 'القطاع (أ)' : 'القطاع (ب)',
                        color: badgeColor
                    });
                }
            });
        ...
        // إذا كنا ما زلنا في كائن (Object)، نغوص أعمق
        if (typeof data === 'object') {
            Object.keys(data).forEach(key => {
                // نمرر المفتاح الحالي كجزء من المسار
                // مثال: "صناعة" -> "غزل ونسيج"
                deepDive(data[key], sectorName + " > " + key, badgeColor);
            });
        }
    }

    // 2. تشغيل البحث في القطاعين
    deepDive(decision104DB.sectorA, 'القطاع (أ)', 'bg-primary');
    deepDive(decision104DB.sectorB, 'القطاع (ب)', 'bg-success');

    // 3. عرض النتائج
    if (matches.length === 0) {
        resultsContainer.innerHTML = `
            <div class="p-3 text-center text-muted border bg-light rounded">
                <i class="fas fa-search-minus mb-2"></i><br>
                لا توجد نتائج مطابقة لـ "${inputField.value}"
            </div>
        `;
    ...
    displayMatches.forEach(match => {
        // تمييز النص المطابق
        // نستخدم تعبير منتظم آمن للعربية
        const safeQuery = inputField.value.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
        const highlightedText = match.activity.replace(
            new RegExp(`(${safeQuery})`, 'gi'), 
            '<span style="background-color: #fff3cd; font-weight: bold;">$1</span>'
        );

        // تنظيف المسار للعرض (إزالة اسم القطاع المكرر)
        let displayPath = match.path.replace('القطاع (أ) > ', '').replace('القطاع (ب) > ', '');

        html += `
            <a href="javascript:void(0);" 
               class="list-group-item list-group-item-action p-2 border-bottom" 
               onclick="selectDecisionActivity('${match.activity.replace(/'/g, "\\'")}', '${match.sector}', '${displayPath.replace(/'/g, "\\'")}')">
                
                <div class="d-flex w-100 justify-content-between align-items-center mb-1">
                    <small class="badge ${match.color} bg-opacity-75">${match.sector}</small>
                </div>
                
                <p class="mb-1 fw-bold text-dark" style="font-size: 0.9rem;">${highlightedText}</p>
                <small class="text-muted"><i class="fas fa-folder-open me-1"></i> ${displayPath}</small>
            </a>
        `;
    });
...
// دالة الاختيار (تأكد أنها موجودة أيضاً)
window.selectDecisionActivity = function(activity, sector, path) {
    const inputField = document.getElementById('activitySearch');
    const resultsContainer = document.getElementById('searchResults');
    ...
    const alertClass = sector.includes('أ') ? 'alert-primary' : 'alert-success';
    const incentive = sector.includes('أ') ? '50%' : '30%';

    detailsContainer.innerHTML = `
        <div class="alert ${alertClass} border-0 shadow-sm mt-3 animate__animated animate__fadeIn">
            <h5 class="alert-heading fw-bold">
                <i class="fas fa-check-circle me-2"></i> النشاط مشمول في ${sector}
            </h5>
            <hr>
            <div class="row">
                <div class="col-md-12 mb-2">
                    <strong>📂 التصنيف:</strong> ${path}
                </div>
                <div class="col-md-12 mb-2">
                    <strong>💰 الحافز الاستثماري:</strong> خصم <span class="badge bg-warning text-dark fs-6">${incentive}</span> من التكلفة الاستثمارية
                </div>
                <div class="col-12 mt-2 p-2 bg-white rounded border">
                    <strong>📝 النشاط المحدد:</strong> ${activity}
                </div>
            </div>
        </div>
    `;
...
// إصلاح زر تفعيل القطاع أ
window.toggleSectorA = function() {
    const isChecked = document.getElementById('sectorA_check').checked;
    const details = document.getElementById('sectorA_details');
    if(details) details.style.display = isChecked ? 'block' : 'none';
};

// إصلاح زر تفعيل القطاع ب
window.toggleSectorB = function() {
    const isChecked = document.getElementById('sectorB_check').checked;
    const details = document.getElementById('sectorB_details');
    if(details) details.style.display = isChecked ? 'block' : 'none';
};

// --- تحديث قوائم القطاع (أ) ---
window.updateSectorASub = function() {
    const mainSelect = document.getElementById('sectorA_main');
    const subSelect = document.getElementById('sectorA_sub');
    const actSelect = document.getElementById('sectorA_activities');
    
    if(!mainSelect || !subSelect) return;
    
    // تصفير القوائم
    subSelect.innerHTML = '<option value="">-- اختر القطاع الفرعي --</option>';
    if(actSelect) actSelect.innerHTML = '<option value="">-- اختر النشاط الاستثماري --</option>';

    const mainKey = mainSelect.value;
    if (!mainKey || typeof decision104DB === 'undefined' || !decision104DB.sectorA) return;

    // جلب البيانات: SectorA -> MainKey
    const subData = decision104DB.sectorA[mainKey];
...
window.updateSectorAActivities = function() {
    const mainKey = document.getElementById('sectorA_main').value;
    const subKey = document.getElementById('sectorA_sub').value;
    const actSelect = document.getElementById('sectorA_activities');
    
    if(!actSelect) return;
    actSelect.innerHTML = '<option value="">-- اختر النشاط الاستثماري --</option>';

    if (!mainKey || !subKey || typeof decision104DB === 'undefined') return;

    // جلب الأنشطة: SectorA -> Main -> Sub
    const activities = decision104DB.sectorA[mainKey]?.[subKey];
...
// --- تحديث قوائم القطاع (ب) ---
window.updateSectorBSub = function() {
    const mainSelect = document.getElementById('sectorB_main');
    const subSelect = document.getElementById('sectorB_sub');
    const actSelect = document.getElementById('sectorB_activities');
    ...
    const mainKey = mainSelect.value;
    if (!mainKey || typeof decision104DB === 'undefined' || !decision104DB.sectorB) return;

    const subData = decision104DB.sectorB[mainKey];
...
window.updateSectorBActivities = function() {
    const mainKey = document.getElementById('sectorB_main').value;
    const subKey = document.getElementById('sectorB_sub').value;
    const actSelect = document.getElementById('sectorB_activities');
    ...
    const activities = decision104DB.sectorB[mainKey]?.[subKey];
...
// -----------------------------------------------------------------------
// 2️⃣ إصلاح المناطق الصناعية (استعادة الواجهة المفقودة)
// -----------------------------------------------------------------------

// تهيئة المستمع عند التحميل
document.addEventListener('DOMContentLoaded', function() {
    const toggleBtn = document.getElementById('toggleIndustrialAreas');
    if (toggleBtn) {
        // إزالة أي مستمعين سابقين (للتأكد) عن طريق استبدال العنصر بـ clone (اختياري) أو مجرد تعيين onchange
        toggleBtn.onchange = function() {
            const card = document.getElementById('industrialAreasCard');
            if (this.checked) {
                card.style.display = 'block';
                // استدعاء دالة الرسم العالمية
                if(window.renderIndustrialAreas) window.renderIndustrialAreas();
            } else {
                card.style.display = 'none';
            }
        };
...
// تعريف دالة الرسم بشكل عالمي
window.renderIndustrialAreas = function() {
    const container = document.getElementById('industrialAreasContent');
    if (!container) return;

    if (typeof industrialDB === 'undefined' || !Array.isArray(industrialDB)) {
        container.innerHTML = '<div class="alert alert-danger m-3">خطأ: قاعدة بيانات المناطق الصناعية غير محملة.</div>';
        return;
    }

    // تجهيز قوائم الفلترة
    const uniqueGovs = [...new Set(industrialDB.map(i => i.governorate).filter(Boolean))].sort();
    const uniqueDeps = [...new Set(industrialDB.map(i => i.dependency).filter(Boolean))].sort();

    // بناء HTML الفلاتر + حاوية الكروت
    const html = `
    <div class="p-3">
        <!-- قسم البحث والفلاتر -->
        <div class="card p-3 mb-3 border-0 bg-light shadow-sm">
            <h5 class="mb-3 text-primary"><i class="fas fa-search"></i> بحث وتصفية المناطق</h5>
            <div class="row g-2">
                <div class="col-md-4">
                    <input type="text" id="indSearchBox" class="form-control" placeholder="اسم المنطقة..." onkeyup="window.filterIndustrialTable()">
                </div>
                <div class="col-md-4">
                    <select id="indGovSelect" class="form-select" onchange="window.filterIndustrialTable()">
                        <option value="">كل المحافظات</option>
                        ${uniqueGovs.map(g => `<option value="${g}">${g}</option>`).join('')}
                    </select>
                </div>
                <div class="col-md-4">
                    <select id="indDepSelect" class="form-select" onchange="window.filterIndustrialTable()">
                        <option value="">كل الجهات</option>
                        ${uniqueDeps.map(d => `<option value="${d}">${d}</option>`).join('')}
                    </select>
                </div>
            </div>
            <div class="mt-2 text-muted small">
                إجمالي المناطق: <strong id="indTotalCount">${industrialDB.length}</strong>
            </div>
        </div>

        <!-- حاوية الكروت -->
        <div id="indCardsGrid" class="row g-3" style="max-height: 500px; overflow-y: auto;">
    ...
    // رسم الكروت الأولية
    window.filterIndustrialTable();
};

// تعريف دالة الفلترة عالمياً
window.filterIndustrialTable = function() {
    const searchVal = document.getElementById('indSearchBox').value.toLowerCase();
    const govVal = document.getElementById('indGovSelect').value;
    const depVal = document.getElementById('indDepSelect').value;
    const grid = document.getElementById('indCardsGrid');
    const countLabel = document.getElementById('indTotalCount');

    if (!grid) return;

    // تصفية
    const filtered = industrialDB.filter(item => {
        const nameMatch = (item.name || '').toLowerCase().includes(searchVal);
        const govMatch = govVal === "" || item.governorate === govVal;
        const depMatch = depVal === "" || item.dependency === depVal;
        return nameMatch && govMatch && depMatch;
    });
    ...
    if (filtered.length === 0) {
        grid.innerHTML = '<div class="col-12 text-center text-muted py-4">لا توجد نتائج مطابقة</div>';
        return;
    }

    // عرض أول 50 نتيجة فقط للأداء
    grid.innerHTML = filtered.slice(0, 50).map(area => `
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm border-0">
                <div class="card-body">
                    <h6 class="text-primary fw-bold">${area.name}</h6>
                    <div class="small text-muted mb-2"><i class="fas fa-map-marker-alt"></i> ${area.governorate}</div>
                    <div class="small mb-3"><strong>التبعية:</strong> ${area.dependency}</div>
                    <button class="btn btn-sm btn-outline-info w-100" onclick="window.showIndustrialDetails('${area.id}')">
                        التفاصيل
                    </button>
                </div>
            </div>
...
// تعريف دالة عرض التفاصيل عالمياً
window.showIndustrialDetails = function(id) {
    const area = industrialDB.find(a => a.id == id);
    if(!area) return;

    // تعبئة المودال
    document.getElementById('industrial-modal-area-name').innerText = area.name;
    document.getElementById('industrial-modal-dependency').innerText = area.dependency;
    document.getElementById('industrial-modal-governorate').innerText = area.governorate;
    document.getElementById('industrial-modal-area-size').innerText = area.area || '-';
    document.getElementById('industrial-modal-decision').innerText = area.decision || 'لا يوجد قرار متاح';

    // إظهار المودال
    document.getElementById('industrial-modal-overlay').style.display = 'flex';
    
    // الخريطة (اختياري)
    if(area.x && area.y && window.L) {
        setTimeout(() => {
            const mapId = 'industrial-area-map';
            const container = document.getElementById(mapId);
            if(container) {
                // إعادة إنشاء الحاوية لتجنب خطأ Map initialized
                const newContainer = container.cloneNode(true);
                container.parentNode.replaceChild(newContainer, container);
                
                const map = L.map(mapId).setView([area.y, area.x], 14);
                L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);
                L.marker([area.y, area.x]).addTo(map).bindPopup(area.name).openPopup();
            }
        }, 200);
    }
};